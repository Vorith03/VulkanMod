 ...
 * 4096 voxels on the GPU and emits deterministic aggregate values used by the
 * startup smoke test. The synchronization and descriptor path are the same pieces
 * future face classification/mesh generation can reuse.</p>
 */
final class VoxelComputeProbe implements AutoCloseable {
    private static final int RESULT_WORDS = 4;
