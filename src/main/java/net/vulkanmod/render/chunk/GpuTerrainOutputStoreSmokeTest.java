...
public final class GpuTerrainOutputStoreSmokeTest {
    ...
    public static void verify() {
        ...
        try {
            ...
            int currentStageSection = 4;
            store.invalidateSection(currentStageSection, 70L);
            var currentStage = requireStagedReservation(store.reserveStaged(
                            currentStageSection, TerrainRenderType.SOLID, 70L, 4),
            ...
            var currentResidency = store.getResidency(
                    currentStageSection, TerrainRenderType.SOLID);
            ...
            var sameGenerationRevoked = requireStagedReservation(store.reserveStaged(
                            currentStageSection, TerrainRenderType.SOLID, 70L, 5),
            ...
            require(!sameGenerationRevoked.complete(5, false)
                            && !store.getResidency(
                                    currentStageSection, TerrainRenderType.SOLID).valid(),
